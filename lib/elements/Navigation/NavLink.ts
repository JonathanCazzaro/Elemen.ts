...
export default class NavLink extends Link {
   ...
   */
  constructor({ id, data_id, classes, exclusionList, textContent, children, target }: LinkConstructor) {
    super({ id, data_id, classes, children, exclusionList, textContent, target });
